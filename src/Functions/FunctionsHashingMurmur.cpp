...
/// chdb-core-lite: all MurmurHash variants are niche; drop them and rely on
/// linker --gc-sections to remove the template instantiations. Users who need
/// a fast 64-bit hash can use cityHash64 or xxHash64.
...
└─────────────┴────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionMurmurHash2_32>(murmurHash2_32_documentation));
...
└──────────────────────┴────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionMurmurHash2_64>(murmurHash2_64_documentation));
...
└─────────────┴────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionMurmurHash3_32>(murmurHash3_32_documentation));
...
└──────────────────────┴────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionMurmurHash3_64>(murmurHash3_64_documentation));
...
└───────────────────────────────────────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionMurmurHash3_128>(murmurHash3_128_documentation));
...
└──────────────────────┴─────────────────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionGccMurmurHash>(gccMurmurHash_documentation));
...
└────────────┴──────────┘
    ...
    CHDB_LITE_HASH(factory.registerFunction<FunctionKafkaMurmurHash>(kafkaMurmurHash_documentation));
}
}
